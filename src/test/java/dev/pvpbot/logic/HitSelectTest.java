...
class HitSelectTest {
    ...
    @Test void resumesAttackingAfterShortEscapeWindow(){assertEquals(HitSelectController.Decision.ATTACK_NOW,c.decide(snapshot(2.5,2,7),BotProfile.defaults("x"),1,.5));}
