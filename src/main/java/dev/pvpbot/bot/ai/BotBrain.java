...
public final class BotBrain {
    ...
    private final LatencyBuffer<PerceptionSnapshot> latency=new LatencyBuffer<>(); private final LatencyBuffer<TargetObservation> targetLatency=new LatencyBuffer<>(); private final HitSelectController hitSelect=new HitSelectController(); private final AimController aim=new AimController(); private final CriticalController critical=new CriticalController(); private final MovementController movement=new MovementController(); private final AdaptationController adaptation=new AdaptationController(); private final Random random=new Random();
