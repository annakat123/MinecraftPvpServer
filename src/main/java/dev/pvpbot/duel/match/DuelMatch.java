...
public final class DuelMatch {
    ...
    public DuelMatch(JavaPluginFacade plugin,Player player,BotProfile profile,Arena arena,ArenaManager arenas,LobbyService lobby,CitizensBotFactory bots,KitDefinition kit,DatabaseService database,Consumer<DuelMatch> closed){this.plugin=plugin;this.player=player;this.profile=profile;this.arena=arena;this.arenas=arenas;this.lobby=lobby;this.bots=bots;this.kit=kit;this.database=database;this.closed=closed;}
